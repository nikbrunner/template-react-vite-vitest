...
**Branch:** `with-ts-query`
**StackBlitz:** [Open Exercise](https://stackblitz.com/github/nikbrunner/template-react-vite-vitest/tree/with-ts-query)
...
- [ ] Show sort direction indicator (↑/↓ or similar)
...
test("pagination controls work", async () => {
    ...
    vi.mocked(api.fetchUsers).mockResolvedValue(generateUsers(25));
